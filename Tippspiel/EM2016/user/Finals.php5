...
else
{
	...
	echo "<title>Tippspiel - Finalspiele</title>";
	echo "</head>";
	echo "<body>";
	...
	for($i=0;$i<100;$i++){
		if(isset($_POST["saveMatch-$i"])){
			...
			$saveMatchErrorText=saveMatch($i, $userId, $team1, $team2);
			$matchnrPost=$i;
		}
	}
	...
	echo "<br>";
	run($userId, "Achtelfinale", $matchnrPost, $saveMatchErrorText);
	echo "<h2>Viertelfinale</h2>";
	$citation->printCitation("Viertelfinale");
	echo "<br>";
	run($userId, "Viertelfinale", $matchnrPost, $saveMatchErrorText);
	echo "<h2>Halbfinale</h2>";
	$citation->printCitation("Halbfinale");
	echo "<br>";
	run($userId, "Halbfinale", $matchnrPost, $saveMatchErrorText);
	...
	if(constant('championshipType') == ScoreDefinitions::CHAMPIONSHIP_TYPE_WM)
  	{
		...
		echo "<br>";
		run($userId, "Platz3", $matchnrPost, $saveMatchErrorText);
	}
	echo "<h2>Finale</h2>";
	$citation->printCitation("Finale");
	echo "<br>";
	run($userId, "Finale", $matchnrPost, $saveMatchErrorText);
}

function run($userId, $finaltype, $matchnrPost, $saveMatchErrorText){
	...
	while($array=mysql_fetch_array($sqlMatches))
	{
		...
		$tippedTeam1=getTippedTeam($username, $matchnr, "teamX");
		$tippedTeam2=getTippedTeam($username, $matchnr, "teamY");
		...
		if(constant('championshipType') == ScoreDefinitions::CHAMPIONSHIP_TYPE_WM)
	  	...
	  	} // TODO else only possible teams for EM
...
function printDescription($matchnr){
	...
	if(constant('championshipType') == ScoreDefinitions::CHAMPIONSHIP_TYPE_WM)
  	...
  	else if(constant('championshipType') == ScoreDefinitions::CHAMPIONSHIP_TYPE_EM)
  	{
		switch($matchnr)
		{
			case 37 : echo "<td></td><td></td><td>Zweiter Gruppe A</td><td> -</td><td>Zweiter Gruppe C</td><td></td><td></td>";break;
			case 38 : echo "<td></td><td></td><td>Sieger Gruppe B</td><td> -</td><td>Dritter Gruppe A/C/D</td><td></td><td></td>";break;
			case 39 : echo "<td></td><td></td><td>Sieger Gruppe D</td><td> -</td><td>Dritter Gruppe B/E/F</td><td></td><td></td>";break;
			case 40 : echo "<td></td><td></td><td>Sieger Gruppe A</td><td> -</td><td>Dritter Gruppe C/D/E</td><td></td><td></td>";break;
			case 41 : echo "<td></td><td></td><td>Sieger Gruppe C</td><td> -</td><td>Dritter Gruppe A/B/F</td><td></td><td></td>";break;
			case 42 : echo "<td></td><td></td><td>Sieger Gruppe F</td><td> -</td><td>Zweiter Gruppe F</td><td></td><td></td>";break;
			case 43 : echo "<td></td><td></td><td>Sieger Gruppe E</td><td> -</td><td>Zweiter Gruppe D</td><td></td><td></td>";break;
			case 44 : echo "<td></td><td></td><td>Sieger Gruppe B</td><td> -</td><td>Zweiter Gruppe F</td><td></td><td></td>";break;
			
			case 45 : echo "<td></td><td></td><td>Sieger Achtelfinale 1</td><td> -</td><td>Sieger Achtelfinale 3</td><td></td><td></td>";break;
			case 46 : echo "<td></td><td></td><td>Sieger Achtelfinale 2</td><td> -</td><td>Sieger Achtelfinale 6</td><td></td><td></td>";break;
			case 47 : echo "<td></td><td></td><td>Sieger Achtelfinale 5</td><td> -</td><td>Sieger Achtelfinale 7</td><td></td><td></td>";break;
			case 48 : echo "<td></td><td></td><td>Sieger Achtelfinale 4</td><td> -</td><td>Sieger Achtelfinale 8</td><td></td><td></td>";break;
			
			case 49 : echo "<td></td><td></td><td>Sieger Viertelfinale 1</td><td> -</td><td>Sieger Viertelfinale 2</td><td></td><td></td>";break;
			case 50 : echo "<td></td><td></td><td>Sieger Viertelfinale 3</td><td> -</td><td>Sieger Viertelfinale 4</td><td></td><td></td>";break;
			
			case 51 : echo "<td></td><td></td><td>Sieger Halbfinale 1</td><td> -</td><td>Sieger Halbfinale 2</td><td></td><td></td>";break;
		}
...
function getTippedTeam($username, $matchnr, $dbColumnTeam){
...
function saveMatch($matchnr, $userId, $team1, $team2){
	...
	while($array=mysql_fetch_array($sqlResultFinals))
	{
		...
		$teamShort1=getShortName($team1);
		$teamShort2=getShortName($team2);
