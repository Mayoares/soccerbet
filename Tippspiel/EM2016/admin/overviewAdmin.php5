...
allGroupMatchesAsOption("SelectedMatchnr");
echo "</td>";
...
function allGroupMatchesAsOption($optionName) {
	include_once("../util/dbutil.php5");
	...
	else
	{
		...
		for ($i=0; $i<$nummatches; $i++)
		{
			...
			$team1 = getTeamName(mysql_result($sqlmatchesResult, $i, "team1"));
			$team2 = getTeamName(mysql_result($sqlmatchesResult, $i, "team2"));
...
function allFinalMatchesAsOption($optionName) {
	include_once("../util/dbschema.php5");
	include_once("../util/dbutil.php5");
	include_once("../../general/log/log.php5");
	$log=new adminlogger();	
