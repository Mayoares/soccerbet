...
function printChampions($userName){
	...
	$europechampion=getTippedTeamRostrum($userName, 1);  if(!isset($europechampion)){$europechampion = "<font color=\"red\"><b> FEHLT! </b></font>";}
	$vice=getTippedTeamRostrum($userName, 2); if(!isset($vice)){$vice = "<font color=\"red\"><b> FEHLT! </b></font>";}
	echo "<table style='font-size:20px'>";
	echo "<tr><td>Europameister &nbsp; &nbsp; &nbsp;</td><td><b>$europechampion</b></td></tr>";
	echo "<tr><td>Vize &nbsp; &nbsp; &nbsp;</td><td><b>$vice</b></td></tr>";
	echo "</table>";
}
