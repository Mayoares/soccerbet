...
else 
{
	...
	echo "<br>";
	echo "Hm, nochmal ";
	echo "<a href='./showAllTipps.php5?userId=$userId' target='Daten'>Alle meine Tipps</a> kontrollieren.";
	echo "<br>";
	echo "<br>";
	echo "<a href='../util/login.php5' target='Daten' onclick='FrameAendern()'/><FONT SIZE=4><b>OK, logout.</b></FONT>";
    echo "<br>";
}
