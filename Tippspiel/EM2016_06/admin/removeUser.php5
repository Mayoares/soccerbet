...
function removeUser($removeUsername, $adminuserId)
{
	...
	if(countTipps($removeUsername) > 0)
	{
		...
		echo "Es m�ssen vorher noch alle seine Tipps gel�scht werden.<br>";
	...
	else
	{
		...
		{
			echo "<br>User $username wurde gel�scht.<br>";
...
{
	echo "Diese Funktion ist bisher nur m�glich, wenn der User noch <b>nichts</b> getippt hat. Wenn doch, bitte an den Administrator wenden.";
	echo "<br>";
	echo "<br>";
	echo "User '<b>$username</b>' wirklich l�schen?";
	echo "<br>";
	echo "<br>";
