...
else
{
	...
	echo "<title>Werke's Tippspiel - Stockerl-Tipps und Torsch�tzenk�nig</title>";
	echo "</head>";
	echo "<body>";
...
function run($userId){
	...
	*/
	...
	if(isset($_POST["topscorer"])){
		...
		if($updated)
		{
			echo "<font color=\"green\">Torsch�tzenk�nig erfolgreich gespeichert :)</font>";
			echo "<br>";
		}
	}
